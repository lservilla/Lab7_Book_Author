...
public class BookTest {
    ...
    public static void main(String[] args) {
        ...
        if( BookConstants.UNKNOWN_YEAR == a2.getDeathYear() ) { tScore++; }
        ...
        if( BookConstants.UNKNOWN_YEAR   == allTheBooks[2].getPublicationYear() ) { tScore++; }
        ...
        if( 2010 == allTheBooks[0].getPublicationYear() ) { tScore++; }
        allTheBooks[0].setPublicationYear( 2023 );
        if( 2010 == allTheBooks[0].getPublicationYear() ) { tScore++; }
